...
var passive_production_factor = 0.3;
	...
	if(available_actions[action_id]['type'] == undefined || available_actions[action_id]['type'] == 'basic')
	{
		...
		if(can_perform == true)
		{
			...
			if(available_actions[action_id]['progress_needed'] != undefined)
			{
				...
				if(current_location == location_id && action_id == current_action_id)
				{
					var passive_production = (available_actions[action_id]['chance'] * gamedata['known_locations'][location_id]['actions'][action_id]['level'] / 100 * passive_production_factor) * available_actions[action_id]['passive_factor'];
					if(passive_production > 0)
					{

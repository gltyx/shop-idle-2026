function parse_monster(monster_id, monster_amount, monster_health_percent, current_id, show_entry){
	...
	if(available_monsters[monster_id] != undefined)
	{
		...
		parsed_item +=				'<div class="item show_entry_' + show_entry + ' item_container_' + monster_id + ' item_container_' + monster_id + '_' + current_id + ' rarity_' + rarity + '" style="background-image:url(images/' + available_monsters[monster_id]['image'] + ');">';

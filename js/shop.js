...
function show_home(){
	...
	$.each(gamedata['counters'], function(counter_id, counter){
		...
		{
			parsed_counter += 	'<div class="single_counter counter_' + counter_id + ' rarity_' + available_items[counter['item_id']]['rarity'] + '" style="background-image:url(images/' + available_items[counter['item_id']]['image'] + ')" onclick="check_single_counter(' + counter_id + ')">';
